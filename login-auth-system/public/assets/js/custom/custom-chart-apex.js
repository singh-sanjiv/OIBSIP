...
$(document).ready(function () {
  ...
  var chart = new ApexCharts(
    document.querySelector("#apex-line-data-chart"),
    options,
  );
  chart.render();
  /* -- Apex Line 1 Chart -- */
  ...
  var chart = new ApexCharts(
    document.querySelector("#apex-line-gradient-chart"),
    options,
  );
  chart.render();
  ...
  var chart = new ApexCharts(
    document.querySelector("#apex-mixed-line-chart"),
    options,
  );
  chart.render();
  /* -----  Apex Bar Chart ----- */
  ...
  var chart = new ApexCharts(
    document.querySelector("#apex-horizontal-bar-chart"),
    options,
  );
  chart.render();
  ...
  var options = {
    ...
    colors: ["#43b1ff", "#9ccc34", "#fcbc04", "#acacb4"],
    series: [44, 55, 67, 83],
  ...
  var chart = new ApexCharts(
    document.querySelector("#apex-donut-chart"),
    options,
  );
  chart.render();
});
