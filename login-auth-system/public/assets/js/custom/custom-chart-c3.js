...
$(document).ready(function () {
  ...
  var scatterPlotChart = c3.generate({
    ...
    color: { pattern: ["#f4f5f7", "#9ccc34", "#43b1ff"] },
    data: {
      xs: {
        setosa: "setosa_x",
  ...
  var stackedBarChart = c3.generate({
    ...
    color: { pattern: ["#f4f5f7", "#43b1ff", "#9ccc34"] },
    data: {
      columns: [
  ...
  var gaugeChart = c3.generate({
    ...
    color: {
      pattern: ["#9ccc34", "#f62525", "#fcbc04", "#43b1ff"],
      threshold: {
        values: [30, 60, 90, 100],
      },
    },
  ...
  var pieChart = c3.generate({
    bindto: "#c3-pie",
    color: { pattern: ["#43b1ff", "#f4f5f7", "#9ccc34"] },
    data: {
      columns: [
        ["SeriesA", 40],
        ["SeriesB", 25],
