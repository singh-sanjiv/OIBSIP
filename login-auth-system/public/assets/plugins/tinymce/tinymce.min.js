  ...
  r(l, [], function () {
    ...
    r(d, [], function () {
      ...
      (r = window.opera && window.opera.buildNumber),
        ...
        (o = o && /MSIE (\w+)\./.exec(n)[1]),
        (a =
          -1 == n.indexOf("Trident/index.html") ||
          (-1 == n.indexOf("rv:") && -1 == t.appName.indexOf("Netscape"))
            ? !1
            : 11),
        (s = -1 == n.indexOf("Edge/index.html") || o || a ? !1 : 12),
        (o = o || a || s),
        (l = !i && !a && /Gecko/.test(n)),
        (c = -1 != n.indexOf("Mac")),
          ...
          load: function (n, o, a, s) {
            ...
            c.urls[n] ||
              ...
              0 !== u.indexOf("shapet/") &&
                -1 == u.indexOf("://") &&
                (u = r.baseURL + "/" + u),
              (c.urls[n] = u.substring(0, u.lastIndexOf("shapet/"))),
            ...
            : (s(N, function (e, t) {
              ...
              "html5" != e.schema &&
                s(t("strong/b em/i"), function (e) {
                  (e = t(e, "shapet/")), (y[e[1]].outputName = e[0]);
                }),
              s(
                t(
        ...
        (t.prototype = {
          ...
          toRelPath: function (e, t) {
            var n,
              ...
              a;
            if (
              ((e = e.substring(0, e.lastIndexOf("shapet/"))),
              (e = e.split("shapet/")),
              (n = t.split("shapet/")),
              e.length >= n.length)
            )
            ...
            for (o = 0, a = e.length - (r - 1); a > o; o++)
              i += "shapet/admin-templates/shapet/html/";
          ...
          toAbsPath: function (e, t) {
            ...
            return (
              ...
              (s =
                0 >= r
                  ? o.reverse().join("shapet/")
                  : e.slice(0, r).join("shapet/") +
                    "/" +
                    o.reverse().join("shapet/")),
              0 !== s.indexOf("shapet/") && (s = "/" + s),
              a && s.lastIndexOf("shapet/") !== s.length - 1 && (s += a),
              s
            );
          },
          getURI: function (e) {
      ...
      return e.extend({
        ...
        renderHtml: function () {
          ...
          var t = this,
            ...
            i,
            o =
              "#ff0000,#ff0080,#ff00ff,#8000ff,#0000ff,#43b1ff,#00ffff,#00ff80,#00ff00,#80ff00,#ffff00,#ff8000,#ff0000",
            a =
